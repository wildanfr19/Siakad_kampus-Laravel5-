...
class JurusanController extends Controller
{
       function json()
       {
            $jurusan = \DB::table('jurusan')->join('fakultas','jurusan.kode_fakultas','=','fakultas.kode_fakultas')->get();

            return Datatables::of($jurusan)
            ->addColumn('action', function($row){
                $action = '<a href="/jurusan/'. $row->kode_jurusan .'/edit" class="btn btn-sm btn-primary"><i class="fas fa-pencil-alt"></i></a>';
