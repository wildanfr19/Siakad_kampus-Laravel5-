...
class FakultasController extends Controller
{
     function json()
    {
        ...
        ->addColumn('action', function($row){
            $action = '<a href="/fakultas/'. $row->kode_fakultas .'/edit" class="btn btn-sm btn-primary"><i class="fas fa-pencil-alt"></i></a>';
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/fakultas')->with('status', 'Data berhasil disimpan ');
    }
