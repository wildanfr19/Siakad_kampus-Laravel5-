   <div class="form-group row">
    ...
    <div class="form-group row">
        <label for="password" class="col-md-4 col-form-label text-md-right">Semester</label>
...
<div class="form-group row">
        <label for="password" class="col-md-4 col-form-label text-md-right">Matakuliah</label>
 ...
 <div class="form-group row">
        <label for="password" class="col-md-4 col-form-label text-md-right">Dosen</label>
 ...
 <div class="form-group row">
        <label for="password" class="col-md-4 col-form-label text-md-right">Ruangan</label>
 ...
 <div class="form-group row">
        <label for="password" class="col-md-4 col-form-label text-md-right">Hari Dan Jam</label>
